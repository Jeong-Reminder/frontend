...
class ThreeBoard extends StatefulWidget {
  ...
  const ThreeBoard({required this.onChecked, super.key});
                          ...
                          children: [
                            ...
                            isEdited
                                ...
                                ? SizedBox(
                                    ...
                                    width: 20,
                                    child: Checkbox(
                                      value: threeBoard[index]['isChecked'] ??
                                          false, // isChecked가 null이면 기본값이 false 사용
                                      onChanged: (value) {
                                        setState(() {
                                          threeBoard[index]['isChecked'] =
                                              value;
                                        });
                                      },
