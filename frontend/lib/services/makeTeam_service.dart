...
class MakeTeamService {
  ...
  // 팀원 모집글 아이디로 조회 API
  Future<Map<String, dynamic>> fetchMakeTeam(int makeTeamId) async {
    ...
    final String baseUrl =
        'https://reminder.sungkyul.ac.kr/api/v1/recruitment/$makeTeamId';
          ...
          (responseData['data'] as List<dynamic>)
              ...
              .map((item) => (item as List<dynamic>).map((innerItem) {
                    ...
                    if (innerMap.containsKey('memberId') &&
                      ...
                      fullDetailsList.add({
                        'id': innerMap['id'] as int,
                        'announcementId': innerMap['announcementId'] as int,
